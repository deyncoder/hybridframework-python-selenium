...
class AddCustomer:
    # Add customer Page
    lnkCustomers_menu_xpath = "//a[@href='#' and @class='nav-link']//p[contains(text(),'Customers')]"
    lnkCustomers_menuitem_xpath = "//a[@href='/Admin/Customer/List' and @class='nav-link']"
    btnAddnew_xpath = "//a[@href='/Admin/Customer/Create' and @class='btn btn-primary']"
    ...
    def setCustomerRoles(self,role):
        ...
        if role == 'Registered':
            ...
            self.listitem = self.driver.find_element(By.XPATH, self.lstitemGuests_xpath)
        time.sleep(3)
        #self.listitem.click()                      # not working on list elements, use execute script instead
